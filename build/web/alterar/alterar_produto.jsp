<%-- 
    Document   : alterar_produto.jsp
    Created on : 27 de nov. de 2023, 18:27:07
...
<html lang="pt-br">
    <head>
        ...
        <title>Alterar Produto JBM</title>
    ...
    <body>
        <div class="wrapper">
                ...
                <ul class="list-unstyled component m-0">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="collapse list-unstyled menu" id="homeSubmenu4">
                            ...
                            <li><a href="index_alterar_produto.jsp"><i class="material-icons">search</i>Alterar Produto [Código EAN]</a></li>
                        </ul>
                    </li>
                    <li class="">
            ...
            <div id="content">
                <div class="top-navbar">
                    <div class="xd-topbar">
                        ...
                        <div class="xp-breadcrumbbar text-center">
                            <h4 class="page-title">Alterar  dados do produto</h4>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">JBM</a></li>
                                <li class="breadcrumb-item active" aria-curent="page">Alterar Produto</li>
                            </ol>
                        </div>				 		 
                    </div>
                </div>
                <br>
                <%
                    String Stringcodigoean = request.getParameter("codigoean");
                    long codigoean = Long.parseLong(Stringcodigoean);
                    ...
                    if (produtoDao.consultarCodigoEAN(produto) != null) {
                %>
                <div class="container ">
                    <form name="frmCadProduto" action="processar_alteracao_produto.jsp" method="post">
                        <div class="row">
                            <!-- Campo Código Interno PrimaryKEY -->
                            <div class="col-md-3">
                                <label for="codigo" class="form-label">Código Interno:</label>
                                <input type="text" class="form-control" name="codigo" id="codigo" value="<%= produto.getCodigo()%>" readonly>
                            </div>
                            <!-- Campo Código Produto -->
                            <div class="col-md-3">
                                <label for="codigoean" class="form-label">Código EAN:</label>
                                <input type="text" class="form-control" name="codigoean" id="codigoean" placeholder="Digite o Código EAN" value="<%= produto.getCodigoean()%>" required>
                            </div>
                            <!-- Campo Descrição-->
                            <div class="col-md-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="preco" id="preco" placeholder="00.00" pattern="^\d+(\.\d{1,2})?$" value="<%= produto.getPreco()%>">
                                </div>
                            </div>
                            <!-- Campo Quantidade do estoque -->
                            <div class="col-md-3">
                                <label for="qtd_estoque" class="form-label">Quantidade Estoque</label>
                                <input type="number" class="form-control" name="qtd_estoque" id="qtd_estoque" value="<%= produto.getQtd_estoque()%>">
                            </div>
                        </div>               
                ...
                <%
                        ...
                        out.println("<br><b>Produto não encontrado!</b>");
                    }
                %>
                <br><br><br><br><br>
                <footer class="footer">
