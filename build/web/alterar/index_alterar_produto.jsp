<%-- 
    Document   : index_alterar_produto
    Created on : 27 de nov. de 2023, 18:28:06
    Author     : 37919058805
--%>
    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content">
                <div class="top-navbar">
                    <div class="xd-topbar">
                        ...
                        <div class="xp-breadcrumbbar text-center">
                            <h4 class="page-title">Alterar Produto [Código EAN]</h4>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">JBM</a></li>
                                <li class="breadcrumb-item active" aria-curent="page">Alterar Produto [Código EAN]</li>
                            </ol>
                        </div>				 		 
                    </div>
                </div>
                <br>
                <div class="container ">
                    <form name="frmAltProduto" action="alterar_produto.jsp" method="post">
                        <div class="mb-3">
                            <label for="codigoean" class="form-label">Código EAN:</label>
                            <input type="text" class="form-control" name="codigoean">
                        </div>
